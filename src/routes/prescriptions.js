 ...
 */
router.get('/templates/new', requireAuth, requireClinicAccess, async (req, res) => {
  try {
 ...
 * Create new template
 */
router.post('/templates', requireAuth, requireClinicAccess, async (req, res) => {
  try {
    const clinicId = req.session.user.clinicId;
    const userId = req.session.user.id;
 ...
 */
router.get('/templates/:id', requireAuth, requireClinicAccess, async (req, res) => {
  try {
    const clinicId = req.session.user.clinicId;
 ...
 */
router.get('/templates/:id/edit', requireAuth, requireClinicAccess, async (req, res) => {
  try {
    const clinicId = req.session.user.clinicId;
 ...
 * Update template
 */
router.post('/templates/:id', requireAuth, requireClinicAccess, async (req, res) => {
  try {
    const clinicId = req.session.user.clinicId;
    const { name, description, medicines, isDefault } = req.body;
    ...
    if (isDefault === 'true' || isDefault === true) {
      await PrescriptionTemplate.update(
        { isDefault: false },
        { where: { clinicId, isDefault: true, id: { [Op.ne]: req.params.id } } }
      );
    }
 ...
 * Delete template
 */
router.post('/templates/:id/delete', requireAuth, requireClinicAccess, async (req, res) => {
  try {
    const clinicId = req.session.user.clinicId;
 ...
 */
router.get('/new/:visitId', requireAuth, requireClinicAccess, async (req, res) => {
  try {
    const clinicId = req.session.user.clinicId;
...
router.post('/', requireAuth, requireClinicAccess, async (req, res) => {
  try {
    const clinicId = req.session.user.clinicId;
    const { visitId, medicines, advice, doctorSignature, doctorName, doctorLicense, templateId } = req.body;
...
router.post('/:id', requireAuth, requireClinicAccess, async (req, res) => {
  try {
    ...
    const userRole = req.session.user.role;
    const userId = req.session.user.id;
    const { medicines, advice, doctorSignature, doctorName, doctorLicense, templateId } = req.body;
